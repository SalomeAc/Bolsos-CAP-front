    ...
    <section className="auth-layout">
      <div className="auth-card auth-card--center" aria-live="polite">
        ...
        <div className="auth-form">
          ...
          <button className="button button-google" onClick={handleGoogleSignIn} disabled={loading}>
          ...
          <p className="muted small" style={{ marginTop: 12 }}>Al ingresar con Google aceptas nuestros términos.</p>
        </div>
      </div>
    </section>
  )
